...
def get_pretrained_resnet18(num_classes: int) -> nn.Module:
...
def get_pretrained_mobilenet_v3_small(num_classes: int) -> nn.Module:
...
def get_model(name: str, num_classes: int) -> nn.Module:
    ...
    if name == "resnet18_pretrained":
        return get_pretrained_resnet18(num_classes=num_classes)
    if name == "mobilenet_pretrained":
        return get_pretrained_mobilenet_v3_small(num_classes=num_classes)
