...
public class FrontServlet extends HttpServlet {
    ...
    private Method getMethod(Class<?> pageClass, String name) {
        Method method = null;
    ...
    private void invokeMethod(Method method, Object page,
                              HttpServletRequest request, Map<String, Object> view) throws ServletException {
        try {
    ...
    private void process(Route route,
        ...
        Method beforeMethod;
        if ((beforeMethod = getMethod(pageClass, "before")) == null) {
            throw new NotFoundException();
        }

        Method actionMethod;
        if ((actionMethod = getMethod(pageClass, route.getAction())) == null) {
            throw new NotFoundException();
        }

        Method afterMethod;
        if ((afterMethod = getMethod(pageClass, "after")) == null) {
            throw new NotFoundException();
        }
        ...
        try {
            ...
            throw new ServletException("Unable to run action [pageClass=" + page.getClass() + ", method=" + actionMethod + "].", e);
